...
//
/// ***
// * Redis client的辅助工具类 * 用于连接Redis服务器 创建不同的Redis Server对应的客户端对象 * @author
// * wangnian * 博客地址：http://my.oschina.net/wangnian
// */
...
//
// /**
// * 使用config创建Redisson * Redisson是用于连接Redis Server的基础类 * @param config
// * * @return
// */
...
// */
// public <V> RSortedSet<V> getRSortedSet(RedissonClient redisson, String
// objectName) {
...
// }
// /**
// * * 此方法不可用在Redisson 1.2 中 * 在1.2.2版本中 可用 * @param redisson * @param
// * objectName * @return
// */
//
// /**
...
// */
// public RCountDownLatch getRCountDownLatch(RedissonClient redisson, String
// objectName) {
