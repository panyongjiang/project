...
import com.uway.nmap.core.flags.ArgumentProperties;
import com.uway.nmap.core.nmap.ExecutionResults;
import com.uway.nmap.core.nmap.NMapExecutionException;
import com.uway.nmap.core.nmap.NMapExecutor;
import com.uway.nmap.core.nmap.NMapInitializationException;
import com.uway.nmap.core.nmap.NMapProperties;
import com.uway.nmap.data.NMapRun;
import com.uway.nmap.parser.OnePassParser;
...
//	}
	...
	public Nmap4j(String filePath, String command ) {
...
//		nmapExecutor = new NMapExecutor(command);
		nmapExecutor = new NMapExecutor(commands);
