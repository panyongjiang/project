...
public interface SiteMapper {
	...
	public List<Map<String, Object>> getAllMaxLastBySite() throws Exception;
	 ...
	 * @throws Exception
	 * @author wanglei
	 * @create_time 2017年8月29日下午3:12:54
	 */
	public List<Map<String, Object>> getSafeSiteByUser(Map<String, Object> paraMap) throws Exception;

	public int getSafeSiteCountByUser(Map<String, Object> paraMap) throws Exception;

	public List<Map<String, Object>> getWafSiteByUser(Map<String, Object> paraMap) throws Exception;

	public int getWafSiteCountByUser(Map<String, Object> paraMap) throws Exception;

	public Map<String, Object> getSiteCount() throws Exception;
