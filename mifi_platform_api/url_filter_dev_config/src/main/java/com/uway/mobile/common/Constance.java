...
public class Constance {
	...
	// redis用户ID存储结构
	public static String REDIS_USER_PRE = "bj_mobile:user:";
	// redis存储用户信息
	public static String REDIS_USER_INFO = "bj_mobile:user_info:";
	// redis存储用户登录IP的信息
	public static String REDIS_LOGIN_IP = "bj_mobile:login_ip:";
	// redis存储相应的敏感词信息
	public static String REDIS_SENSITIVE_WORDS = "bj_mobile:sensitive:list_word";
	// 密码密钥
	public static String KEY = "BJ@uway#mobile";
	...
	//安全设置对应的开关
	public static String SEC_CHEAT_WEBSITE = "secCheatWebsite";
	public static String SEC_SHAM_ADV = "secShamAdv";
	public static String SEC_SEXY_INFO = "secSexyInfo";
	public static String SEC_HARM_PROGRAM = "secHarmProgram";
	public static String SEC_TORT_CONTENT = "secTortContent";
	public static String SEC_ILLEGAL_GAMBLE = "secIllegalGamble";
	public static String SEC_ILLEGAL_SITE = "secIllegalSite";
	public static String SEC_PHISHING_SITE = "secPhishingSite";
	public static String SEC_SEXY_SITE = "secSexySite";
