...
//        	System.out.println("key2:"+b2.getKeyAsString()+" --->"+b2.getDocCount());
	...
	public static String genLineChart(String title,List<Bucket> buckets){  
		setChartTheme();
        // A网站的访问量统计  
...
//        	System.out.println(key+"**************"+new BigDecimal(key).toPlainString());
        	lineDataset.addValue(bucket.getDocCount(), "漏洞", key.substring(0, 4)+"-"+key.substring(4,6)+"-"+key.substring(6,8));
        }
