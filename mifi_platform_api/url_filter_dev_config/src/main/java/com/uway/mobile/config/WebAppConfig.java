...
public class WebAppConfig extends WebMvcConfigurerAdapter {
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		registry.addInterceptor(userInterceptor).addPathPatterns("/config/**");
		registry.addInterceptor(userInterceptor).addPathPatterns("/device/**");
		registry.addInterceptor(userInterceptor).addPathPatterns("/home/**");
		registry.addInterceptor(userInterceptor).addPathPatterns("/log/**");
		registry.addInterceptor(userInterceptor).addPathPatterns("/strategy/**");
		registry.addInterceptor(userInterceptor).addPathPatterns("/plat/**");
	}
}
