...
public class ElasticSearchUtils {
	 ...
	 * @param value
	 */
	public static void updateDoc(Client esClient, String index, String type,String id,String fieldName,String value)throws Exception{
		UpdateRequest uRequest = new UpdateRequest();
